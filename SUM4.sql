...
-- 20221018_임진호. PRICE 컬럼 NOT NULL 조건 삭제
...
COMMENT ON COLUMN TICKETING.MOVIE_TITLE IS '영화명';
COMMENT ON COLUMN TICKETING.CINEMA_NAME IS '영화관';
COMMENT ON COLUMN TICKETING.SHOW_DATE IS '상영일';
...
COMMENT ON COLUMN TICKETING.STATUS IS '예매상태';
...
COMMENT ON COLUMN COMMENTS.CM_ID IS '댓글작성자아이디';
COMMENT ON COLUMN COMMENTS.M_NO IS '영화번호';
COMMENT ON COLUMN COMMENTS.CONTENT  IS '댓글내용';
COMMENT ON COLUMN COMMENTS.REG_DATE IS '등록날짜';
COMMENT ON COLUMN COMMENTS.UP_DATE IS '수정날짜';
