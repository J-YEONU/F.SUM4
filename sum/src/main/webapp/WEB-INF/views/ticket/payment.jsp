...
<section id="tSection">
	...
	<div id="tagtitle2"><img src="${ path }/resources/image/tag_gray.png" id="tag"> 좌석선택</div>
	<div id="tagtitle3"><img src="${ path }/resources/image/tag.png" id="tag"> 결제</div>
		<div id="bottom">
			<div id="tagdiv1"></div>
			<div id="tagdiv2"></div>
			<div id="tagdiv3"></div>
	...
	<div id="subtitle"><img src="${ path }/resources/image/tag.png" id="tag"> 결제 금액</div>
	</div>
